              ...
              >
                {item.image ? (
                  <div className="relative h-40 mb-3 rounded-xl overflow-hidden bg-surface/80 flex items-center justify-center border border-surface-darker/30">
                    ...
                    {item.category && <span className="absolute top-2 right-2 px-2 py-0.5 bg-craft text-white text-[10px] font-bold rounded-full z-20 shadow-sm">{item.category}</span>}
                  </div>
                ) : (
